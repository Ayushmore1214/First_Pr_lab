...
- Being patient and encouraging with people who are just starting out
...
- Dismissive comments ("this is obvious," "just Google it," "why would anyone not know this")
- Harassment, bullying, or targeted negativity of any kind
- Discriminatory language or behavior based on gender, sexuality, race, religion, age, disability, or any other protected characteristic
- Publishing someone's private information without their explicit consent
- Condescending behavior toward beginners or anyone asking for help

---

## Scope

This Code of Conduct applies everywhere project discussions happen: GitHub issues, pull requests, comments, the repository itself, and any direct communication related to this project.
...
This Code of Conduct is adapted from the [Contributor Covenant](https://www.contributor-covenant.org/), version 2.1, with modifications to reflect the learning-focused nature of this project.

---

*The spirit of this document is simple: be the kind of contributor you wish you'd had when you were just getting started.*
